function [SolidAngleArea,AceptanceAngle,SpotDiameter]=FunctionAcceptanceAngle(Mean,LambdaLower,LambdaUpper,Diameter,Distance)
...
fprintf('ACEPTANCE ANGLE & SOLID ANGLE:\n');
